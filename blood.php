...
<body>
	...
	<div style="width:540px;margin : 0 auto; text-align:left;" >
		...
		<div id="demo">
			...
			<span class="progressBar" id="element1"><?php echo round($vol_current/$vol_max*100)?>%</span><br/>
			...
			<span class="options"><a href="#" onclick="myJsProgressBarHandler.setPercentage('element1','+1');return false;"><img src="images/icons/add.gif" alt="" title="" onmouseout="$('Text1').innerHTML ='&laquo; Select Options'" onmouseover="$('Text1').innerHTML ='Add 1%'"/></a></span>

...
<head>
    ...
    <script>
        var int=self.setInterval("makeRequest('http://heroeverything.com/api.php/get/2')",1000);
...
$json_string = `curl -XGET http://heroeverything.com/api.php/get/$barid`;
...
<div style="width:540px;margin : 0 auto; text-align:left;">
    ...
    <div id="demo">
        ...
        <br/><br/>
        <button type="button" style="background-color: #000000;border:0px #000000 solid;float: right" id="donate" onclick="makeDonate('http://heroeverything.com/api.php/trigger/')"><img width="150" src="./eco.png"></button>
    </div>
...
>>>>>>> 19bbb502dd3c9822a3845792d88021af7b40c824:www/blood.php

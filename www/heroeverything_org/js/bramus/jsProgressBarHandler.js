...
var defaultOptions = {
    ...
    width: 399,										// Width of the progressbar - don't forget to adjust your image too!!!
    boxImage: 'images/bramus/percentImage_cool.png',			// boxImage : image around the progress bar
    barImage: 'images/bramus/percentImage_back_cool.png',	// Image to use in the progressbar. Can be an array of images too.
    height: 89,										// Height of the progressbar - don't forget to adjust your image too!!!
...
var defaultOptions1 = {
    animate: true,										// Animate the progress? - default: true
    showText: true,										// show text with percentage in next to the progressbar? - default : true
    width: 583,										// Width of the progressbar - don't forget to adjust your image too!!!
    boxImage: 'images/bramus/1.png',			// boxImage : image around the progress bar
    barImage: 'images/bramus/2.png',	// Image to use in the progressbar. Can be an array of images too.
    height: 225,										// Height of the progressbar - don't forget to adjust your image too!!!
    onTick: function (pbObj) {
        return true
    }
}
...
var defaultOptions2 = {
    ...
    showText: true,										// show text with percentage in next to the progressbar? - default : true
    width: 583,										// Width of the progressbar - don't forget to adjust your image too!!!
    boxImage: 'images/bramus/3.png',			// boxImage : image around the progress bar
    barImage: 'images/bramus/4.png',	// Image to use in the progressbar. Can be an array of images too.
    height: 225,										// Height of the progressbar - don't forget to adjust your image too!!!
    onTick: function (pbObj) {
        return true
    }
...
var defaultOptions3 = {
    ...
    showText: true,										// show text with percentage in next to the progressbar? - default : true
    width: 583,										// Width of the progressbar - don't forget to adjust your image too!!!
    boxImage: 'images/bramus/5.png',			// boxImage : image around the progress bar
    barImage: 'images/bramus/6.png',	// Image to use in the progressbar. Can be an array of images too.
    height: 225,										// Height of the progressbar - don't forget to adjust your image too!!!
    onTick: function (pbObj) {
        return true
    }
...
var defaultOptions4 = {
    ...
    showText: true,										// show text with percentage in next to the progressbar? - default : true
    width: 583,										// Width of the progressbar - don't forget to adjust your image too!!!
    boxImage: 'images/bramus/looser.gif',			// boxImage : image around the progress bar
    barImage: 'images/bramus/percentImage_back_cool.png',	// Image to use in the progressbar. Can be an array of images too.
    height: 225,										// Height of the progressbar - don't forget to adjust your image too!!!
    onTick: function (pbObj) {
        return true
...
JS_BRAMUS.jsProgressBar.prototype = {
    ...
    initialize: function (el, percentage, options) {
        ...
        // get the options
        //var pattern = /^0%/;
        /*if (pattern.test($(el).innerHTML.trim())) {
            this.options = Object.clone(defaultOptions4);
        } else */
        if ($(el).innerHTML.indexOf('_1') > -1) {
            this.options = Object.clone(defaultOptions1);
        } else if ($(el).innerHTML.indexOf('_2') > -1) {
            this.options = Object.clone(defaultOptions2);
        } else if ($(el).innerHTML.indexOf('_3') > -1) {
            this.options = Object.clone(defaultOptions3);
        } else {
        ...
        this.el = $(el);
        this.id = $(el).id;
        this.percentage = $(el).innerHTML.replace("%", "").replace("_1", "").replace("_2", "").replace("_3", "");							// Set to 0 intially, we'll change this later.
        this.backIndex = 0;							// Set to 0 initially
        this.numPreloaded = 50;							// Set to 0 initially
        ...
        if ($(el).innerHTML.indexOf('0%') > -1) {
            this.initialPos = this.options.width * (-1) + 1;	// Initial postion of the background in the progressbar (0% is the middle of our image!)
            this.pxPerPercent = this.options.width / 126;		// Define how much pixels go into 1%
        } else if ($(el).innerHTML.indexOf('_1') > -1) {
            this.initialPos = this.options.width * (-1) + 1;	// Initial postion of the background in the progressbar (0% is the middle of our image!)
            this.pxPerPercent = this.options.width / 126;		// Define how much pixels go into 1%
        } else if ($(el).innerHTML.indexOf('_2') > -1 || $(el).innerHTML.indexOf('_3') > -1) {
            this.initialPos = this.options.width * (-1) + 122;	// Initial postion of the background in the progressbar (0% is the middle of our image!)
            this.pxPerPercent = this.options.width / 128;		// Define how much pixels go into 1%
        } else {
    ...
    processQueueEntry: function (targetPercentage) {
        ...
        if (targetPercentage == 0)        alert("你已經死囉！！");
...
JS_BRAMUS.jsProgressBarHandler.prototype = {
    ...
    initialize: function () {
        ...
        $$('span.progressBar').each(function (el) {
            ...
            this.pbArray[el.id] = new JS_BRAMUS.jsProgressBar(el, parseInt(el.innerHTML.replace("%", "").replace("_1", "").replace("_2", "").replace("_3", "")));

...
<head>
    ...
    <script>
        ...
        function makeDonate(url) {
            ...
            /*httpRequest.onreadystatechange = function () {
                alertDonate(httpRequest);
            };*/
            httpRequest.open('POST', url, true);
            httpRequest.setRequestHeader("Content-type","application/x-www-form-urlencoded");
            httpRequest.send("barid=2&action=inc&vol=10");
            alert(httpRequest.responseText);
        }
...
<div style="width:540px;margin : 0 auto; text-align:left;">
    ...
    <div id="demo">
        ...
        <br/><br/>
        <button type="button" id="donate" onclick="makeDonate('http://10.0.0.188/api.php/trigger')"><img width="150" src="./eco.png"></button>
    </div>
